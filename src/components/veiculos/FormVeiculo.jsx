...
const FormVeiculo = (props) => {
    ...
    //inputs
    const [modelo, setModelo] = useState(props.veiculo ? props.veiculo.modelo : '');
    const [chassi, setChassi] = useState(props.veiculo ? props.veiculo.chassi : '');
    const [anoFabricacao, setAnoFabricacao] = useState(props.veiculo ? props.veiculo.ano_fabricacao : '');
    const [anoModelo, setAnoModelo] = useState(props.veiculo ? props.veiculo.ano_modelo : '');
    const [codigoFipe, setCodigoFipe] = useState(props.veiculo ? props.veiculo.codigo_fipe : '');
    const [valor, setValor] = useState(props.veiculo ? props.veiculo.valor : '');
    ...
    return (
        <div>
            ...
            <Row>
                <Col>
                    <FormGroup>
                        <Button onClick={validaCampos}>{props.veiculo ? 'ALTERAR' : 'CADASTRAR'}</Button>
                    </FormGroup>
                </Col>
            </Row>
        </div>
